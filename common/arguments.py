...
def get_args():
    ...
    parser.add_argument("--time-steps", type=int, default=5000, help="number of time steps")
    ...
    parser.add_argument("--tau", type=float, default=0.05, help="parameter for updating the target network")
    ...
    parser.add_argument("--save-rate", type=int, default=40000, help="save model once every time this many episodes are completed")
